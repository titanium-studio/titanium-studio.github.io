...
//#endregion
//#region Progress circle draw with canvas 
...
reDraw = (firstColor = "#efefef",secondColor = "#555555") => {
    ...
    circles.forEach((circle, i) => {
        ...
        drawCircle(ctx, firstColor, 100)
        drawCircle(ctx, secondColor, percent)
    })
}
reDraw()
//#endregion
